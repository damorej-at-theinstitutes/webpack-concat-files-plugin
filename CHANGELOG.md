...
## [Unreleased]
### Changed
- Upgraded `mocha` dev dependency to resolve `y18n` v4.0.0 prototype pollution security vulnerability
- Upgraded to `webpack` v4.46.x for Webpack 4 tests
- Upgraded to `webpack` v5.36.x for Webpack 5 tests
